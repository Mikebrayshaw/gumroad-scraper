    ...
    def record_snapshots(
        ...
        for product, scored in zip(products, scored_products):
            ...
            snapshot = {
                ...
                "price_is_pwyw": scored.get("price_is_pwyw", payload.get("price_is_pwyw", False)),
                ...
                "revenue_confidence": scored.get("revenue_confidence", payload.get("revenue_confidence", "low")),
                "opportunity_score": scored.get("opportunity_score"),
                "scraped_at": now,
            }
            snapshot["raw_source_hash"] = _compute_snapshot_hash(snapshot)
